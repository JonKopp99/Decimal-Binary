...
def decode(digits, base):
    ...
    # ...
    hex = string.printable#string.digits + string.ascii_uppercase + "+/"
    digits = digits[::-1].lower()
    hexTuple = enumerate(digits)
    final_num = 0
    for power, value in hexTuple:
        final_num += hex.index(value)*(base ** power)
    return final_num
